    ...
    <div className="bg-gray-100 min-h-screen">
      <div className="flex flex-col md:flex-row h-screen pt-12 md:pt-0">
        ...
        <div className="flex flex-col md:flex-row flex-1 h-full">
          {/* On mobile: Show sidebar when no group is selected, hide when group is active */}
          ...
          {/* On mobile: Hide empty state when no group is selected, show chat container when active */}
