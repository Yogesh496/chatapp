...
const MessagingSidebar = () => {
  ...
  // Handle user selection with mobile view awareness
  const handleUserSelect = (user) => {
    if (!isSelectingChats) {
      setSelectedUser(user);
      // No need to hide anything here - the layout component will handle showing/hiding
    }
  };
  ...
  // Check if sidebar should be hidden (mobile with selected user)
