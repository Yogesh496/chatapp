// import { Camera, Edit3Icon, Image, LogOutIcon, PlusCircle, Trash2, X } from "lucide-react";
...
//   const { selectedGroup, updateGroupProfile, updateGroupName, getUsers, addUserToGroup, users } = useChatStore();
...
//     console.log("Delete chat functionality");
//   };
...
//             <X size={24} />
//           </button>
//           <p className="text-xl font-semibold text-gray-800">Group Info</p>
...
//             <p className="text-xs text-gray-500">Click the camera icon</p>
//             {selectedFile && (
//               <button
//                 className="px-2 py-1 bg-gray-600 text-white text-xs rounded-lg hover:bg-gray-700"
...
//           <div className="flex items-start justify-between w-full text-xs text-gray-500 border-b py-3">
...
//             <button
//               className="w-full flex items-center gap-3 py-2 px-2 font-semibold rounded-lg hover:bg-gray-100 transition duration-200"
//               onClick={() => setShowMediaFiles(true)}
//             >
//               <Image size={22} className="text-gray-700" /> Gallery & Docs
//             </button>
//           </div>
...
//               className="w-full py-2 px-2 font-semibold flex items-start  text-black rounded-lg hover:bg-gray-100"
//             >
...
//               < MdGroup size={22} className="text-gray-800 mb-2" />
//               <p className="text-sm font-semibold text-gray-800 mb-2">{selectedGroup.members.length} Members</p>
//             </div>
//             <ul className="text-xs text-gray-800 space-y-2 max-h-36 overflow-y-auto">
...
//               className="w-full py-2 px-2 font-semibold text-red-600 rounded-lg hover:bg-red-100 flex items-center gap-2"
//             >
//               <Trash2 size={20} />
//               Delete Chat
//             </button>
...
const GroupContactInfo = ({ onClose }) => {
  const {
    ...
    leaveGroup,
    users,
  } = useChatStore(); // Added leaveGroup here
  const [showMediaFiles, setShowMediaFiles] = useState(false);
  const [selectedFile, setSelectedFile] = useState(null);
